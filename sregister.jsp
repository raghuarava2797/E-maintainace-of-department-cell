...
<center>
<form action="SRegisterServlet" method="post" name="form1" onsubmit="return formValidation()">
<h4>${msg}</h4>
<table class="tablelayout curve"><caption>Student Register</caption><br>
<tr><td><label><strong>Student name : </strong></label></td><td><input type="text" name="sname" placeholder="first name"><br><br>
</td></tr>
<tr><td><label><strong>Student ID : </strong></label></td><td><input type="text" name="sid" placeholder="student id"><br><br>
</td></tr>
...
<tr><td><label><strong>Passing year : </strong></label></td><td>
<select name="p">
...
<br><br></td></tr>
<tr><td><label><strong>DOB : </strong></label></td><td><input type="date" name="dob" placeholder="dob"><br><br>
</td></tr>
<tr><td><label><strong>Branch : </strong></label></td><td><input type="text" name="branch" placeholder="branch"><br><br>
</td></tr>
<tr><td><label><strong>Section : </strong></label></td><td><input type="text" name="section" placeholder="section"><br><br>
</td></tr>
